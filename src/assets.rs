...
impl Category {
    pub fn install_header(self) -> &'static str {
        match self {
            Category::ClaudeSkill => "Installing Claude Code skills...",
            Category::CodexSkill => "Installing Codex skills...",
    ...
    pub fn status_header(self) -> &'static str {
        match self {
            Category::ClaudeSkill => "Claude Code skills",
            Category::CodexSkill => "Codex skills",
    ...
    pub fn is_skill(self) -> bool {
        matches!(self, Category::ClaudeSkill | Category::CodexSkill)
    }
...
pub const HARNESS_ASSETS: &[Asset] = &[
    ...
    // --- Codex skills (mirror of the Claude Code skills above) ---
    Asset {
        rel_path: &[".agents", "skills", "bob-identify", "SKILL.md"],
        content: include_str!("templates/skills/bob-identify.md"),
        category: Category::CodexSkill,
        included_in_minimal: true,
        upgrade_safe: true,
    },
    Asset {
        rel_path: &[".agents", "skills", "bob-onion", "SKILL.md"],
        content: include_str!("templates/skills/bob-onion.md"),
        category: Category::CodexSkill,
        included_in_minimal: true,
        upgrade_safe: true,
    ...
    Asset {
        rel_path: &[".agents", "skills", "bob-spec", "SKILL.md"],
        content: include_str!("templates/skills/bob-spec.md"),
        category: Category::CodexSkill,
        included_in_minimal: true,
        upgrade_safe: true,
    ...
    Asset {
        rel_path: &[".agents", "skills", "bob-survey", "SKILL.md"],
        content: include_str!("templates/skills/bob-survey.md"),
        category: Category::CodexSkill,
        included_in_minimal: true,
        upgrade_safe: true,
    ...
    Asset {
        rel_path: &[".agents", "skills", "bob-stories", "SKILL.md"],
        content: include_str!("templates/skills/bob-stories.md"),
        category: Category::CodexSkill,
        included_in_minimal: true,
        upgrade_safe: true,
    ...
    Asset {
        rel_path: &[".agents", "skills", "bob-nfr", "SKILL.md"],
        content: include_str!("templates/skills/bob-nfr.md"),
        category: Category::CodexSkill,
        included_in_minimal: true,
        upgrade_safe: true,
    ...
    Asset {
        rel_path: &[".agents", "skills", "bob-compliance", "SKILL.md"],
        content: include_str!("templates/skills/bob-compliance.md"),
        category: Category::CodexSkill,
        included_in_minimal: true,
        upgrade_safe: true,
    ...
    Asset {
        rel_path: &[".agents", "skills", "bob-model", "SKILL.md"],
        content: include_str!("templates/skills/bob-model.md"),
        category: Category::CodexSkill,
        included_in_minimal: true,
        upgrade_safe: true,
    ...
    Asset {
        rel_path: &[".agents", "skills", "bob-model", "scripts", "server.cjs"],
        content: include_str!("templates/scripts/bob-model/server.cjs"),
        category: Category::CodexSkill,
        included_in_minimal: true,
        upgrade_safe: true,
    ...
    Asset {
        rel_path: &[".agents", "skills", "bob-model", "scripts", "helper.js"],
        content: include_str!("templates/scripts/bob-model/helper.js"),
        category: Category::CodexSkill,
        included_in_minimal: true,
        upgrade_safe: true,
    ...
    Asset {
        rel_path: &[".agents", "skills", "bob-model", "scripts", "start-server.sh"],
        content: include_str!("templates/scripts/bob-model/start-server.sh"),
        category: Category::CodexSkill,
        included_in_minimal: true,
        upgrade_safe: true,
    ...
    Asset {
        rel_path: &[".agents", "skills", "bob-model", "scripts", "stop-server.sh"],
        content: include_str!("templates/scripts/bob-model/stop-server.sh"),
        category: Category::CodexSkill,
        included_in_minimal: true,
        upgrade_safe: true,
    ...
    Asset {
        rel_path: &[".agents", "skills", "visual-md", "SKILL.md"],
        content: include_str!("templates/skills/visual-md.md"),
        category: Category::CodexSkill,
        included_in_minimal: true,
        upgrade_safe: true,
    ...
    Asset {
        rel_path: &[".agents", "skills", "visual-md", "scripts", "server.cjs"],
        content: include_str!("templates/scripts/visual-md/server.cjs"),
        category: Category::CodexSkill,
        included_in_minimal: true,
        upgrade_safe: true,
    ...
    Asset {
        rel_path: &[".agents", "skills", "visual-md", "scripts", "client.js"],
        content: include_str!("templates/scripts/visual-md/client.js"),
        category: Category::CodexSkill,
        included_in_minimal: true,
        upgrade_safe: true,
    ...
    Asset {
        rel_path: &[".agents", "skills", "visual-md", "scripts", "md2html.cjs"],
        content: include_str!("templates/scripts/visual-md/md2html.cjs"),
        category: Category::CodexSkill,
        included_in_minimal: true,
        upgrade_safe: true,
    ...
    Asset {
        rel_path: &[".agents", "skills", "visual-md", "scripts", "slugify.cjs"],
        content: include_str!("templates/scripts/visual-md/slugify.cjs"),
        category: Category::CodexSkill,
        included_in_minimal: true,
        upgrade_safe: true,
    ...
    Asset {
        rel_path: &[".agents", "skills", "visual-md", "scripts", "package.json"],
        content: include_str!("templates/scripts/visual-md/package.json"),
        category: Category::CodexSkill,
        included_in_minimal: true,
        upgrade_safe: true,
